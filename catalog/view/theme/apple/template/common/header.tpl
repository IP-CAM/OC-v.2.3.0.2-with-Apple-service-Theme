    ...
    <div class="row">
          ...
          <ul class="dropdown-menu dropdown-menu-right">
            ...
            <?php } ?>
					...
					<li class="header-phone"><?php echo $telephone; ?></span></li>
        </li>
			</ul>
    </div>
  </div>
		...
		<div class="row">
			<div class="col-sm-9">
					<nav id="menu" class="navbar">
						<div class="navbar-header"><span class="toggle-top-text hidden-lg hidden-sm hidden-md"><?php echo $text_information; ?>:</span>
